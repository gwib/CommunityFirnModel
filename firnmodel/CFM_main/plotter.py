...
def plotter(rfolder,rfile):
    ...
    #plt.plot(cdensity,cdepth,'r') #TODO: had to uncomment this to run the plotter, what is to be shown here??
    # plt.ylim([0,50])
    ...
    plt.plot(temperature[jj, 1:], depth[jj, 1:])
    plt.xlabel('Temperature [K]')
    plt.ylabel('Depth [m]')
    #plt.plot(cdensity, cdepth, 'r')  # unresolved ref
    # plt.ylim([0,50])
...
#
#    rfolder = 'CFMexample' #path to the results folder
#
